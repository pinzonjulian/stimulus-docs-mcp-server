...
// URL constants
const GITHUB_API_BASE_URL = 'https://api.github.com/repos/hotwired/stimulus-site';
const GITHUB_RAW_BASE_URL = 'https://raw.githubusercontent.com/hotwired/stimulus/main/docs';
